"""
HITLApproval — Human-in-the-Loop Approval Workflow for IntentShield
====================================================================
Implements pause-and-approve for high-impact actions.

Instead of a binary ALLOW/BLOCK decision, IntentShield can now return
...
logger = logging.getLogger("intentshield.hitl")
